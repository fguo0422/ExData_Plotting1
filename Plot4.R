...
#1st plot
plot(power_hw$Time,power_hw$Global_active_power,type ='l',ylab='Global Active Power',xlab='' )
#2nd plot
plot(power_hw$Time,power_hw$Voltage,type ='l',ylab='Voltage',xlab='datetime' )
#3rd plot
plot(power_hw$Time,power_hw$Sub_metering_1,type ='l',ylab='Energy sub metering',xlab='',col='black' )
points(power_hw$Time,power_hw$Sub_metering_2,type ='l',ylab='Energy sub metering',xlab='',col='red' )
points(power_hw$Time,power_hw$Sub_metering_3,type ='l',ylab='Energy sub metering',xlab='',col='blue' )
legend('topright',c('Sub_metering_1','Sub_metering_2','Sub_metering_3'),
       col=c('black','red','blue'),text.col='black',lty =c(1,1,1) ,bty='n')

plot(power_hw$Time,power_hw$Global_reactive_power,type ='l',ylab='Global_reactive_power',xlab='datetime' )
